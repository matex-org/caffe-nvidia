#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU8_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU8_HPP_
...
class MPIGossipParamsGPU8 : public GPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsGPU8(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsGPU8();
