#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU3_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU3_HPP_
...
class MPIGossipParamsGPU3 : public GPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsGPU3(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param,
          int comm_threads, bool cube, bool rotate);
  virtual ~MPIGossipParamsGPU3();
