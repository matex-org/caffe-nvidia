#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU7_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU7_HPP_
...
class MPIGossipParamsGPU7 : public GPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsGPU7(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsGPU7();
