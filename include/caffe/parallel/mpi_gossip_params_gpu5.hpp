#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU5_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_GPU5_HPP_
...
class MPIGossipParamsGPU5 : public GPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsGPU5(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsGPU5();
