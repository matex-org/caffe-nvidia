#ifndef CAFFE_PARALLEL_MPI_ASYNC_GPU_HPP_
#define CAFFE_PARALLEL_MPI_ASYNC_GPU_HPP_
...
class MPIAsyncGPU : public GPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIAsyncGPU(shared_ptr<Solver<Dtype> > root_solver,
